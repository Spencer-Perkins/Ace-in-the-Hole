...
<body>
	...
	<main>
		...
		<section class="homeHero"><p class="homeHeroText">Ace in the Hole Multisport Events</p></section>
        <section id="about">
			...
			<p>You must wear your chip timing piece during the entire event. You will be given a band that will hold your chip timing piece around your ankle throughout the entire event. Be sure that it is snapped tightly. Be sure to have your chip timing piece on before you start the race and be sure to step over the timing mats after each segment of the race. If you are wearing a wet-suit, make sure the timing piece goes under your wetsuit, otherwise you will have a very difficult time getting your wet suit off.</p>
		...
		<section id="galleryRow1">
			<a target="_blank" href="images/biking1.jpg" class="col span_4_of_12">
				<img src="images/biking1.jpg" alt="An outdoor bike race."></a>
			<a target="_blank" href="images/swimming1.jpg" class="col span_4_of_12">
				<img src="images/swimming1.jpg" alt="An ocean swim race."></a>
			<a target="_blank" href="images/running1.png" class="col span_4_of_12">
				<img src="images/running1.png" alt="An ocean swim race."></a>
		</section>
		
		<section id="galleryRow2">
			<a target="_blank" href="images/biking2.jpg" class="col span_4_of_12">
				<img src="images/biking2.jpg" alt="Motion blurred image of a bike race."></a>
			<a target="_blank" href="images/swimming2.jpg" class="col span_4_of_12">
				<img src="images/swimming2.jpg" alt="Swimmers in wetsuits running into the ocean."></a>
			<a target="_blank" href="images/running2.jpg" class="col span_4_of_12">
				<img src="images/running2.jpg" alt="Runners in an outdoor race."></a>
		</section>
	
		<aside id="socialmedia1" class="col span_6_of_12">
			<h3>Facebook</h3>
			<div class="fb-page" data-href="https://www.facebook.com/cas222cascade/" data-tabs="timeline" data-width="350" data-height="300" data-small-header="false" data-adapt-container-width="true" data-hide-cover="false" data-show-facepile="true"><blockquote cite="https://www.facebook.com/cas222cascade/" class="fb-xfbml-parse-ignore"><a href="https://www.facebook.com/cas222cascade/">CAS 222</a></blockquote></div>
		</aside>
		
		<aside id="socialmedia2" class="col span_6_of_12">
			<h3>Twitter</h3>
			<a class="twitter-timeline" data-height="300" href="https://twitter.com/pcccas222?ref_src=twsrc%5Etfw">PCC222 Tweets</a> <script async src="https://platform.twitter.com/widgets.js" charset="utf-8"></script> 
		</aside>
	</main>
